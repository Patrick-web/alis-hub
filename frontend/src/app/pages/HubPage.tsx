                ...
                <div className="flex items-center gap-[12px]">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-foreground/40 mt-[1px] truncate">
                      {state.recentLandingZone.productDisplayName ||
                        state.recentLandingZone.product}
                    </p>
                  </div>
                  <div className="flex items-center gap-[6px] shrink-0">
                    ...
                    <Icon
                      ...
                      className="text-foreground/30 group-hover:text-brand text-base transition-colors"
                    />
                  </div>
                </div>
              </button>
