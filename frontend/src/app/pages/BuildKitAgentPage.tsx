    ...
    >
      <div className="px-[24px] py-[20px] max-w-[900px] mx-auto w-full">
        <div className="flex flex-col gap-[16px]">
          ...
          <div>
            <h2 className="text-[16px] font-bold text-foreground mb-[12px]">
              Don't have an agent?
            </h2>
            <div className="border-b border-border mb-[16px]" />

            <p className="text-[12px] text-foreground/70 leading-[1.6] mb-[16px]">
              Begin your journey by creating a new Agent within the Alis Build ecosystem. This
              process is designed to be transparent and automated, giving you a powerful starting
              point without hiding the details. The initialisation process takes a few minutes as
              the system automatically creates your dedicated agent service, scaffolds the necessary
              infrastructure code, and verifies dependencies. This is a one-time setup.
            </p>
              ...
              <div className="flex flex-col gap-[8px]">
                <div className="flex gap-[10px]">
                  <Icon
                    ...
                    className="text-brand text-[16px] shrink-0 mt-[1px]"
                  />
                  <div>
                    <p className="text-[11px] font-bold text-foreground">Name</p>
                    <p className="text-[10px] text-foreground/50">
                      A unique identifier for your agent (e.g.,{" "}
                      <code className="font-mono">joe</code>).
                    </p>
                  </div>
                </div>
                <div className="flex gap-[10px]">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-foreground/50">
                      A tagline outlining your agent's capabilities and purpose.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col gap-[8px]">
                  <div className="flex gap-[10px]">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-foreground/50">
                        All generated files are visible in your file explorer. You own the code.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-[10px]">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-foreground/50">
                        Glass Box development — you can inspect, modify, and extend every part of
                        the generated setup.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-[8px]">
                  <div className="flex gap-[10px]">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-foreground/50">
                        We automatically compile and prepare the deployment artifacts.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-[10px]">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-foreground/50">
                        Your agent is immediately deployed to the development environment, making it
                        live and testable.
                      </p>
                    </div>
                  </div>
          ...
          <div>
            <h2 className="text-[16px] font-bold text-foreground mb-[12px] mt-[16px]">
              Add your Tool to your Agent
            </h2>
            <div className="border-b border-border mb-[16px]" />
            ...
            >
              <p className="text-[11px] text-foreground/60 mb-[12px] leading-[1.6]">
                This step connects your new, deployed tool directly to your Agent. You register this
                new capability within your Agent's configuration. This crucial registration allows
                your Agent to discover the tool's existence, understand its purpose (from your
          ...
          <div>
            ...
            >
              <p className="text-[11px] text-foreground/60 mb-[12px] leading-[1.6]">
                Once your agent is initialized, built, and thoroughly tested, the final step is to
                make it operational and accessible across your organization by publishing it to
                Gemini Enterprise.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Your agent code is packaged into a secure, production-ready container image.",
                  },
                  {
                    icon: "solar:server-square-linear",
                    title: "Serverless Hosting",
                    desc: "Deployed to scalable serverless infrastructure with automatic scaling and zero-downtime.",
                  },
                  {
                    icon: "solar:buildings-linear",
                    title: "Enterprise Registration",
                    desc: "Your agent is registered within the Gemini Enterprise platform for secure invocation.",
                  },
                ].map(({ icon, title, desc }) => (
