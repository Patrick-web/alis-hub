...
const stages = [
  {
    ...
    description: 'Deploy and configure a Users service that handles authentication and user management for your AI launchpad. This service controls who can access the launchpad and what capabilities they have.',
  ...
  },
  {
    ...
    description: 'Register the launchpad domain and identity service domain for your organisation. These domains serve as the entry points for users and handle OAuth flows.',
  ...
  },
  {
    ...
    description: 'Deploy the launchpad service that provides a unified interface for users to access AI tools, agents, and workflows within your organisation.',
