...
const steps = [
  {
    ...
    description: 'Use your organisation Forgejo instance to create private repositories for product code, prototypes, templates, and internal tools.',
    icon: 'solar:folder-add-linear',
  },
  {
    title: 'Clone with HTTPS',
    description: 'Use the repository HTTPS URL from Forgejo to clone source code into your local Alis Build workspace.',
    icon: 'solar:download-linear',
  },
  {
    title: 'Push normal Git changes',
    description: 'Work locally with Git as usual: branch, commit, push, review, and merge through your organisation-owned forge.',
