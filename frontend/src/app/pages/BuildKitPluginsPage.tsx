...
const clients: Array<{
...
}> = [
  {
    ...
    description: 'Install the Alis Build extension for Gemini CLI to enable Alis Build MCP tools, skills, and agent workflows directly in your terminal.',
  ...
  },
  {
    ...
    description: 'Install the Alis Build plugin for Claude Code to add Alis Build MCP tools, skills, and guided workflows to your Claude sessions.',
  ...
  },
  {
    ...
    description: 'Add the Alis Build plugin to Cursor to bring Alis Build MCP tools and skills into your AI-powered editor sessions.',
  ...
  },
  {
    ...
    description: 'Configure Alis Build MCP for OpenCode using the JSON config below. Add this to your OpenCode configuration file.',
  ...
  },
  {
    ...
    description: 'Install the Alis Build plugin for Codex to enable Alis Build MCP tools and agent workflows in your Codex sessions.',
    installLabel: 'Plugin repository',
