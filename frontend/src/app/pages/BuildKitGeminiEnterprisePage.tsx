...
const stages = [
  {
    ...
    description:
      "Open the Google Cloud Console to create and configure your Gemini Enterprise application. This is the foundation for granting your organisation access to Gemini Enterprise capabilities.",
  ...
  },
  {
    ...
    description:
      "Set up and manage subscriptions to control which users in your organisation have access to Gemini Enterprise. Configure seat allocations and access tiers as required.",
  ...
  },
  {
    ...
    description:
      "Configure Workforce Identity Federation to allow your organisation's users to authenticate with Google Cloud using your existing identity provider (Google Workspace, Microsoft Entra, etc.).",
  ...
  },
  {
    ...
    description:
      "Set up data connectors to allow Gemini Enterprise to access your organisation's data sources. This enables grounded responses and enterprise-specific knowledge in Gemini interactions.",
  ...
  return (
    <PageLayout
      ...
      actions={
        <Button
          variant="secondary"
          onClick={() => Browser.OpenURL(GEMINI_ENTERPRISE_URL)}
      ...
      <div className="px-[24px] py-[20px] max-w-[900px] mx-auto w-full">
        <div className="flex flex-col gap-[16px]">
          <p className="text-[12px] text-foreground/70 leading-[1.6]">
            The Gemini Enterprise flow walks you through setting up Google Gemini Enterprise for
            your organisation. This includes creating an enterprise application, managing
            subscriptions, configuring identity federation, and connecting your data sources.
          </p>
