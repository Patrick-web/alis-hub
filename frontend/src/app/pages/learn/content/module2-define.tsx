            ...
            {[
              {
                ...
                desc: 'Every field has an explicit type. No more guessing if "amount" is a string or a number.',
              },
              {
                label: "Code generated",
                desc: "Client stubs and server interfaces are generated automatically — no hand-written HTTP clients.",
              },
              {
                label: "Versioned",
                desc: "Service versions (v1, v2) are explicit in the package name. Breaking changes are intentional.",
              },
              {
                label: "Language agnostic",
                desc: "The same .proto generates Go, TypeScript, Python, Java, and more from one definition.",
              },
            ].map(({ label, desc }) => (
              <div
                key={label}
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <div className="flex flex-col gap-[6px]">
            {[
              {
                file: "pb.go",
                desc: "Go structs for all message types, with JSON/proto marshalling.",
              },
              {
                file: "grpc.pb.go",
                desc: "The server interface your Go code must implement, plus the client stub.",
              },
              {
                file: "pb.gw.go",
                desc: "HTTP→gRPC transcoding gateway (serves REST calls alongside gRPC).",
              },
              {
                file: "openapi.json",
                desc: "OpenAPI v3 spec, auto-generated from the proto HTTP bindings.",
              },
            ].map(({ file, desc }) => (
              <div
                key={file}
              ...
              >
                <code className="text-[10px] font-mono text-brand shrink-0 w-[140px]">
                  *_{file}
                </code>
