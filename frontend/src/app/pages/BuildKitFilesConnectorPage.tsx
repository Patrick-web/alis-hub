      ...
      <div className="px-[24px] py-[20px] max-w-[900px] mx-auto w-full">
        <div className="p-[20px] bg-[#2c2c2c] border border-[#464646] rounded-[4px]">
          <div className="flex items-center gap-[8px] mb-[10px]">
            <div className="px-[6px] py-[2px] border border-[#555] rounded-[2px]">
              <span className="text-[9px] font-bold text-[rgba(255,255,255,0.4)] uppercase font-['JetBrains_Mono',sans-serif]">
                Private Preview
              </span>
            </div>
          </div>
          <div className="flex items-center gap-[12px] mb-[12px]">
            <div className="size-[36px] rounded-[4px] bg-[rgba(248,129,169,0.1)] border border-[rgba(248,129,169,0.2)] flex items-center justify-center shrink-0">
              <Icon icon="solar:file-text-linear" className="text-[#f881a9] text-[18px]" />
            </div>
            <div>
              <p className="text-[13px] font-bold text-white font-['JetBrains_Mono',sans-serif]">Files Connector</p>
              <p className="text-[11px] text-[rgba(255,255,255,0.5)]">This flow is in private preview.</p>
            </div>
          </div>
          <div className="flex items-start gap-[10px] px-[14px] py-[12px] bg-[rgba(248,129,169,0.06)] border border-[rgba(248,129,169,0.2)] rounded-[4px]">
            ...
            <p className="text-[11px] text-[rgba(255,255,255,0.65)] leading-[1.5]">
