    ...
    >
      ...
      <ContextMenu>
            ...
            {aiGenerating && (
              <HoverCard openDelay={300}>
                <HoverCardTrigger asChild>
                  <div className="flex items-center gap-[5px] pl-[7px] pr-[7px] h-[22px] rounded-[3px] border border-purple-500/20 bg-purple-500/[0.08] shrink-0">
                    ...
                    <Icon
                      ...
                      className="text-[10px] text-purple-300/80 shrink-0"
                    />
                ...
                <HoverCardContent
                  side="top"
                  align="start"
                  className="w-64 font-mono text-[11px] space-y-1.5"
                >
                  <p className="font-bold text-foreground flex items-center gap-[6px]">
                    <Icon
                      icon="solar:cpu-bolt-linear"
                      className="text-[11px] text-purple-300/80 shrink-0"
                    />
                    Local AI generating
                  </p>
              ...
              return (
                <HoverCard key={n.id} openDelay={300}>
                  ...
                  <HoverCardContent
                    side="top"
                    align="start"
                    className="w-72 font-mono text-[11px] space-y-1.5"
                  >
                    <p className="font-bold text-foreground flex items-center gap-[6px]">
                      <Icon
                        icon={TASK_ICON[task.type]}
                        className="text-[11px] text-foreground/50 shrink-0"
                      />
        ...
        <ContextMenuContent className="min-w-[120px]">
          <ContextMenuItem disabled={taskNotifs.length === 0} onClick={closeAllChips}>
            Close All
          </ContextMenuItem>
        </ContextMenuContent>
      </ContextMenu>
