    ...
    >
      ...
      <div className="flex flex-row items-center justify-between size-full">
        <div className="content-stretch flex gap-[10px] items-center p-[10px] relative">
          ...
          <div className="flex flex-col font-['Fira_Code',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[11px] text-white whitespace-nowrap">
            <p className="leading-[normal]">{label}</p>
          </div>
        </div>
        <div className="pr-[10px]">
          <Icon icon="solar:alt-arrow-right-linear" className="text-white text-sm" />
        </div>
      </div>
    </button>
  );
