...
function DateSection({
  ...
  return (
    <div>
      <div
        className="px-[15px] py-[10px] text-[10.5px] font-bold text-foreground/20 uppercase tracking-[0.8px] sticky top-0 z-10"
...
export function NotificationCenter() {
  const { state, unreadCount, markRead, markAllRead, dismiss, clearAll, setFocusTaskId } =
    useNotifications();
