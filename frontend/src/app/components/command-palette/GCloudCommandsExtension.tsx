...
const GCLOUD_TOOLS: { id: string; title: string; keywords: string[]; icon: React.ComponentType<{ className?: string }> }[] = [
  ...
  { id: 'artifacts', title: 'Open Artifact Registry', keywords: ['artifacts', 'registry', 'docker', 'gar'], icon: DatabaseIcon },
