// Fuzzy command scorer ported from the `command-score` algorithm used by cmdk.
// Returns a score in [0, 1]; 0 means no match. Higher is a better match.
...
function commandScoreInner(
  ...
  while (index >= 0) {
    ...
    if (
      ...
      transposedScore *= SCORE_TRANSPOSITION;
      if (transposedScore > score) {
